export const Blogs = [
  ...
  {
    id: 2,
    name: "React Query vs Conventional Data Fetching Method",
  ...
  {
    id: 3,
    name: "5 Javascript Concepts every beginner programmer should know",
    tags: ["javascript", "es6"],
    date: "6 July, 2021",
    imgSrc:
  ...
  {
    id: 4,
    name: "Step by Step Guide in Understanding Redux and Redux ToolKit.",
  ...
  {
    id: 5,
    name: "React Hooks Series: useState and its Advanced UseCases.",
  ...
  {
    id: 6,
    name: "Build and host an API with Nodejs and Heroku",
    tags: ["react", "css"],
    date: "5 Jan, 2021",
    imgSrc:
  ...
  {
    id: 7,
    name: "Filtering Data in React using hooks",
